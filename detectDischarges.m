function [dischargeData] = detectDischarges(patientID,data,Fs,method,channel)
...
% detecting dischrges.
tSec = linspace(1,size(data,2)./Fs,size(data,2));
...
ampThresh = eta*nanstd(HGenvelope);
...
if strcmp(saveFlag,'Y')
    ...
    save(fullfile('~/Data/Seizures/detectedDischarges',fName),'dischargeData')
end
